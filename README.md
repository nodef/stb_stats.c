...
It is developed by [Gerben Voshol](https://github.com/gerbenvoshol).
...
And then include `stb_stats.h` as follows:
...
If you add the path `node_modules/stb_stats.c` to your compiler's include paths.

```bash
$ clang -I./node_modules/stb_stats.c main.c  # or, use gcc
$ gcc   -I./node_modules/stb_stats.c main.c
```
...
[![SRC](https://img.shields.io/badge/src-repo-green?logo=Org)](https://github.com/gerbenvoshol/Statistics-Tool-Box)
[![ORG](https://img.shields.io/badge/org-nodef-green?logo=Org)](https://nodef.github.io)
![](https://ga-beacon.deno.dev/G-RC63DPBH3P:SH3Eq-NoQ9mwgYeHWxu7cw/github.com/nodef/stb_stats.c)
